...
const CustomRenderFields: React.FC<Props> = props => {
    const {
        fieldSchema,
        fieldTypes,
        filter,
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (
                                        isFieldAffectingData &&
                                        permissions?.[field?.name]?.[operation]?.permission ===
                                            false
                                    ) {
                                        readOnly = true;
                                    }
                                        ...
                                        return (
                                            <RenderCustomComponent
                                                ...
                                                componentProps={{
                                                    ...
                                                    path:
                                                        field.path ||
                                                        (isFieldAffectingData ? field.name : ''),
                                                    fieldTypes,
                                                    indexPath: incomingIndexPath
...
export default CustomRenderFields;
